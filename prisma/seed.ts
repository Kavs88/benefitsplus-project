...
async function main() {
  ...
  const event1 = await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        "Escape to a peaceful mountain retreat for a weekend of yoga, meditation, and wellness. Experience the perfect blend of relaxation and rejuvenation in the heart of the Rockies.",
  ...
  const event2 = await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        "Learn to cook authentic Italian cuisine with a master chef in an intimate setting. From pasta making to wine pairing, discover the secrets of Italian gastronomy.",
  ...
  const event3 = await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        "Capture stunning landscapes while hiking through scenic trails with professional guidance. Perfect for both beginners and advanced photographers.",
  ...
  const event4 = await prisma.event.upsert({
    ...
    create: {
      ...
      description:
        "Join us for a transformative meditation session led by certified mindfulness instructors. Learn techniques for stress reduction and mental clarity.",
  ...
  await prisma.review.upsert({
    ...
    create: {
      ...
      rating: 5,
      comment:
        "Amazing experience! The yoga retreat was exactly what I needed. The instructors were knowledgeable and the location was breathtaking.",
      eventId: event1.id,
      authorId: member1.id,
    },
  });
  ...
  await prisma.review.upsert({
    ...
    create: {
      ...
      rating: 4,
      comment:
        "Great cooking class! I learned so much about Italian cuisine. The chef was patient and the food was delicious.",
      eventId: event2.id,
      authorId: member2.id,
    },
  });
  ...
  await prisma.review.upsert({
    ...
    create: {
      ...
      rating: 5,
      comment:
        "Incredible photography workshop! The instructor helped me improve my skills significantly. The locations were stunning.",
      eventId: event3.id,
      authorId: member1.id,
    },
  });
  ...
  await prisma.review.upsert({
    ...
    create: {
      ...
      rating: 4,
      comment:
        "Very relaxing meditation session. The instructor was calming and the techniques were easy to follow.",
      eventId: event4.id,
      authorId: member2.id,
    },
  });
