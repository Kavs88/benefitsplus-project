...
export type DetailedEvent = Prisma.EventGetPayload<{
  include: {
    partner: true;
    categories: true;
  };
...
export type DiscountWithPartnerAndCategories = Prisma.DiscountGetPayload<{
...
export type DetailedDiscount = Prisma.DiscountGetPayload<{
  include: { partner: true; categories: true };
}> & {
  partner: User;
  categories: Category[];
