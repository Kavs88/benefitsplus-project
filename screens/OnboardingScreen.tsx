...
export default function OnboardingScreen() {
  ...
  return (
    <View style={tw`flex-1 bg-[#F7F7FA] px-6 pt-16`}>
      <Text style={tw`text-[28px] font-bold text-[#1D1D1F] mb-2`}>
        What makes a great experience?
      </Text>
      <Text style={tw`text-base text-[#8A8A8E] mb-8`}>
        Pick one to start personalizing your benefits.
      </Text>
      <FlatList
        data={interests}
        numColumns={2}
        ...
        renderItem={({ item }) => (
          ...
          >
            <Feather
              ...
              style={tw`mb-2`}
            />
            <Text style={tw`text-base font-medium text-[#1D1D1F]`}>
              {item.label}
            </Text>
          </TouchableOpacity>
        )}
