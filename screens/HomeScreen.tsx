...
const mockEvents: Event[] = [
  {
    ...
    description:
      "Escape to a peaceful mountain retreat for a weekend of yoga, meditation, and wellness.",
    date: "2024-03-15",
  ...
  },
  {
    ...
    description:
      "Learn to cook authentic Italian cuisine with a master chef in an intimate setting.",
    date: "2024-03-20",
  ...
  },
  {
    ...
    description:
      "Capture stunning landscapes while hiking through scenic trails with professional guidance.",
    date: "2024-03-25",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Unlock exclusive experiences and deals from premium partners. From
            wellness retreats to culinary adventures, find your next
